  ...
  return (
    ...
    >
      ...
      <div className="hidden md:block">
        <button 
          onClick={onOpenQuiz}
          className="px-6 py-2.5 bg-caramel hover:bg-caramel/90 text-espresso font-semibold rounded-full text-sm font-dm-sans shadow-[0_0_10px_var(--color-caramel)] hover:shadow-[0_0_20px_var(--color-caramel)] transition-all duration-300 cursor-pointer"
        >
          Find My Coffee
        </button>
      </div>
        ...
        {isOpen && (
          ...
          >
            ...
            <button 
              ...
              className="w-full mt-2 px-6 py-2.5 bg-caramel text-espresso font-semibold rounded-full shadow-[0_0_10px_var(--color-caramel)] cursor-pointer"
            >
              Find My Coffee
            </button>
          </motion.div>
